...
int main(){
        ...
        //this works only with char declaration way apparently(because char strings are size specified, unlike string strings, *yes*).
        //so we use this generalization for string type strings:
